            ...
            <div class="row">
                <div class="col mt-sm-3">
                    <form action="/penduduk/update/<?=$penduduk['id'];?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text"
                                    ...
                                    id="nama" autofocus name="nama"
                                    value="<?=(old('nama')) ? old('nama') : $penduduk['nama']?>">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="jenkel" id="jenkel">
                                    <option value="Laki-laki"
                                        <?=($penduduk['jenkel'] == 'Laki-laki') ? 'selected' : '';?>>
                                        Laki-laki</option>
                                    <option value="Perempuan"
                                        <?=($penduduk['jenkel'] == 'Perempuan') ? 'selected' : '';?>>
                                        Perempuan</option>
                                </select>
                                <div class="invalid-feedback">
                                    <?=$validation->getError('tgl_lahir');?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text"
                                    ...
                                    id="usia" name="usia" value="<?=(old('usia')) ? old('usia') : $penduduk['usia']?>">
                                <div class="invalid-feedback">
                        ...
                        <a href="/dashboard/detail/<?= $penduduk['id']; ?>" class="btn btn-warning mb-3">Batal</a>
                    </form>
                </div>
            </div>
        </div>

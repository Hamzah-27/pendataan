...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Pencatatan Penduduk</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        ...
                        <p class="badge badge-success text-white"><?=(in_groups('Admin')) ? 'Admin' : ''; ?></p>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/"
                                        class="nav-link <?= ($title === 'Dashboard | Admin') ? 'active' : '' ; ?> ">
                                        <i class="nav-icon fas fa-circle-notch"></i>
                                        <p>Dashboard</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/dashboard/datapenduduk"
                                        class="nav-link <?= ($title === 'Data penduduk') ? 'active' : '' ; ?>">
                                ...
                                <li class="nav-item">
                                    <a href="/dashboard/create"
                                        class="nav-link <?= ($title === 'Insert data') ? 'active' : '' ; ?>">
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2021-2022
            <a href="https://instagram.com/hamzah_r27">Hamzah Risvi</a>.</strong>
        All rights reserved.
